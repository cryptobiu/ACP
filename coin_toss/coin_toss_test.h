...
/*
void test_tcp_proxy_coin_toss(const char * proxy_ip, const u_int16_t proxy_port, const unsigned int id, const unsigned int count,
							  const char * party_file, std::vector<u_int8_t> & random);
